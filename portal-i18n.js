(function(){
  ...
  var phrases=[
    ...
    ['Старт / заново','Почати заново','Start / restart'],['Начать заново','Почати заново','Start over'],['Начать сначала','Почати спочатку','Start again'],['Старт заново','Почати заново','Start over'],['Играть','Грати','Play'],['Начать','Почати','Start'],['Заново','Спочатку','Restart'],['Сброс','Скинути','Reset'],['Выход','Вихід','Exit'],['Назад','Назад','Back'],
  ...
  phrases=phrases.concat([
    ...
    ['НАЧАТЬ','ПОЧАТИ','START'],['ПАУЗА','ПАУЗА','PAUSE'],['ПРОДОЛЖИТЬ','ПРОДОВЖИТИ','CONTINUE'],['ЗАНОВО','СПОЧАТКУ','RESTART'],['В МЕНЮ','У МЕНЮ','TO MENU'],['ОЙ-ОЙ!','ОЙ-ОЙ!','UH-OH!'],['СЧЕТ','РАХУНОК','SCORE'],['РЕКОРД','РЕКОРД','BEST'],['ИГРАТЬ СНОВА','ГРАТИ ЗНОВУ','PLAY AGAIN'],['ШАРИКИ POP!','КУЛЬКИ POP!','BUBBLE POP!'],['ИГРАТЬ','ГРАТИ','PLAY'],['GAME OVER','КІНЕЦЬ ГРИ','GAME OVER'],
